                                ...
                                <template #content>
                                                    ...
                                                    <div v-for="certificat in filteredCertificats" :key="certificat.id"
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            <div v-if="form.certificats[certificat.id].document || form.certificats[certificat.id].document_existant"
                                                                ...
                                                                <span class="truncate">
                                                                    {{ form.certificats[certificat.id].document
                                                                        ?
                                                                        getFileName(form.certificats[certificat.id].document)
                                                                        :
                                                                        form.certificats[certificat.id].document_existant.nom_fichier
                                                                    }}
                                                                </span>
                                                                <span v-if="form.certificats[certificat.id].document"
                                                                    class="text-gray-400">
                                                                    ({{
                                                                ...
                                                                <span
                                                                    v-if="form.certificats[certificat.id].document_existant && !form.certificats[certificat.id].document"
                                    ...
                                    <div class="flex justify-end gap-2 mt-6">
                                        <Button label="Annuler" icon="pi pi-times"
                                            ...
                                            @click="cancel" />
                                        <Button label="Mettre à jour" icon="pi pi-save" type="submit"
