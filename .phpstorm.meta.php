...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\USB\Herd\GestionMilitaire\public\storage' => 'string',
            ...
            'logging.channels.admin_actions.driver' => 'string',
            'logging.channels.admin_actions.path' => 'string',
            'logging.channels.admin_actions.level' => 'string',
            'logging.channels.admin_actions.days' => 'integer',
            'logging.channels.admin_actions.replace_placeholders' => 'boolean',
            'mail.default' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\USB\\Herd\\GestionMilitaire\\public\\storage',
...
'logging.channels.errorlog.replace_placeholders','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.admin_actions.driver',
'logging.channels.admin_actions.path','logging.channels.admin_actions.level','logging.channels.admin_actions.days','logging.channels.admin_actions.replace_placeholders','mail.default',
...
'sanctum.csrf-cookie','dashboard','dashboard.section',
'dashboard.export-proposables-annee-n','dashboard.export-proposables-annee-n1','dashboard.export-retraites-annee-n','dashboard.export-retraites-annee-n1','alertes.index',
'alertes.marquer-vue','alertes.marquer-tout-vue','alertes.check-renouvellements','alertes.generer','contrats.index',
'contrats.store','contrats.show','contrats.historique','grades.index','grades.show',
'grades.store','certificats.index','certificats.create','certificats.store','certificats.show',
'certificats.edit','certificats.update','certificats.destroy','militaires.export','militaires.export.template',
'militaires.import','militaires.import.process','militaires.index','militaires.create','militaires.store',
'militaires.show','militaires.edit','militaires.update','militaires.destroy','eligibilites.index',
'eligibilites.stats','eligibilites.filtered','eligibilites.export','profile.edit','profile.update',
...
'alertes.index','app','auth.confirm-password','auth.forgot-password','auth.login',
'auth.register','auth.reset-password','auth.verify-email','certificats.index','certificats.show',
...
'components.responsive-nav-link','components.secondary-button','components.text-input','dashboard','eligibilites.index',
'grades.index','grades.show','layouts.app','layouts.guest','layouts.navigation',
'militaires.create','militaires.edit','militaires.import','militaires.index','militaires.show',
...
'C:.Users.USB.Herd.GestionMilitaire.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
